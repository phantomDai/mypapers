...
We selected three state-of-the-art concurrent priority queue classes as the subject programs for our study: \texttt{SimpleLinear}, \texttt{SimpleTree}, and \texttt{SequentialHeap}. We used mutation analysis \cite{demillo1978hints} to generate a total of 320 mutants, which includes 312 traditional mutants and 8 concurrent mutants. Each mutants was created by applying a syntactic change (i.e. traditional mutation operator and concurrent mutation operator \cite{Bradbury2006})
