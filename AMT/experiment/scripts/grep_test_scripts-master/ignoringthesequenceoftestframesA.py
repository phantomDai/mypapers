...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug 19 16:51:05 2019
based on the parition_scheme_1.1, this script is 
...
with open('partition_scheme_1.1', 'r') as file:
    for line in file:
...
with open('partition_scheme_1.2', 'w') as f:
