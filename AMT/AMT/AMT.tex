...
\begin{abstract}
  ...
  To improve the efficiency of MT, researchers have focused their effort on generating better MRs or source test cases, while ignoring the impact of test execution.
...
The fault-detecting efficiency of MT relies on the quality of MRs and the source test cases. There are astronomically large number of studies to investigate generate
...
Since MT was first published, a considerable number of studies have been reported from various aspects \cite{segura2016survey}. To improve the efficiency of MT, most of studies
have paid their
attention to identify the better MRs, which are more likely to be violated. For the  efficiency of MRs, several factors such as the difference between the source and follow-up
...
\begin{figure}[!htp]
  \centering
  \includegraphics[width=0.45\textwidth]{figs//result//fmeasure}
  \caption{F-measure Boxplots for Each Program}
  \label{figure:fmeasure}
\end{figure}
\begin{figure}[!htp]
  \centering
  \includegraphics[width=0.45\textwidth]{figs//result//nmeasure}
...
\begin{enumerate}[(1)]
  ...
  Asrafi et al. \cite{asrafi2011testing} conduct a case study to analyze the relationship between the execution behavior and the fault-detection  efficiency of metamorphic relations
   by code coverage criteria, and the results showed a strong correlation between the code coverage achieved by a metamorphic relation and its fault-detection efficiency.

  Source test cases also have a important impact on the fault detection efficiency of MT.
  Chen et al. \cite{chen2004metamorphic} compared the effects of source test cases generated by special value testing and random testing on the efficiency of MT, and found that
  ...
  \item
  \emph{Combination with other techniques:} In order to improve the applicability and efficiency of MT, it has been integrated into other techniques.
