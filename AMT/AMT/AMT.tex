...
\begin{table*}[hbt]
  ...
  GUN                           &\texttt{grep}        &C         &10,068  &20         &20          &12         &552 \& 3380\\ \midrule
...
\begin{table}
	...
	\multicolumn{2}{l}{\multirow{2}{*}{Techniques}}     &Test case             &MRs selection  \\
	                      &                             &selection strategy    &strategy \\ \midrule
	                      &\multirow{2}{*}{M-AMT}       &MAPT                  &RT  \\
	Proposed              &                             &MAPT                  &PBMR \\ \cmidrule(lr){2-4}
	Techniques            &\multirow{2}{*}{R-AMT}       &RAPT                  &RT \\
	                      &                             &RAPT                  &PBMR \\ \midrule
	                      &MT                           &RT                    &RT \\
	Baselines             &MT-ARTsum                    &ARTsum                &RT \\
	                      &MT-DRT                       &DRT                   &RT \\
	\bottomrule
	\end{tabular}
\end{table}
...
\begin{table}[htb]
  ...
  1                &\multicolumn{1}{c|}{\multirow{4}{*}{class}}                &first calss        \\ \cline{3-3}
                   ...
                   &\multicolumn{1}{c|}{}                                      &Economy class       \\ \hline
