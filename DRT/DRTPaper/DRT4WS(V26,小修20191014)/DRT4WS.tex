...
\textcolor{red}{Although a number of web services are publicly available, their implementations are not accessible due to some reason. Consequently, they are not suitable for evaluation because our experiments need their coding for creating faulty mutants. Therefore, we} selected three web services as the subject programs for our study, and implemented them ourselves, based on real-life specification:
